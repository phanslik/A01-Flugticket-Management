	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == submitButton) {
			...
			try {
				...
				jdbc.connect(
						hostnameTextfield.getText().toString(),
						portnameTextfield.getText().toString(),
						databaseTextfield.getText().toString(), 
				...
				l = jdbc.getAllCountries().length;
				
				for(int i = 0;i<l;i++){
					boo.depCountry.addItem(jdbc.getAllCountries()[i]);
				}
			} catch (Exception e1) {
